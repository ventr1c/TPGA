...
class Backdoor:
    ...
    def 
    (self, idx_attach, features,edge_index,edge_weight,device):
    ...
    def get_poisoned(self, idx_atk):
        ...
        with torch.no_grad():
            # poison_x, poison_edge_index, poison_edge_weights = self.
            # (self.idx_trojan,self.features,self.edge_index,self.edge_weights,self.device)
